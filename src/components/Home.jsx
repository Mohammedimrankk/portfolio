...
const Home=()=>{
    return (<div name="home" className='w-full h-screen  bg-[#0a192f]'>
        ...
        <div className="max-w-[1000px] mx-auto flex flex-col justify-center h-full">
            ...
            <p className="text-[#8892b0] py-4 max-w-[700px]">I'm a full-stack developer specialicing in building (and occassionally designing) 
                exceptional digital experience. Currently, I'm focused on building responseive full-stack web application.</p>
            <div>
